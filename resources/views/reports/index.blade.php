           ...
           <table class="table table-striped">
               ...
               @forelse($reports as $report)
                   <tr>
                       ...
                       <td><a href="{{ route('reports.view', ['slug' => $report->slug]) }}" class="btn btn-default">View</a></td>
                       <td><a href="{{ route('reports.notify', ['id' => $report->id]) }}" class="btn btn-default">Send Parent Notification</a></td>
